...
plot_collapsed_two(
    filepath    = './anc3_native_af3_processed_tmscores_new.txt',
    out_png     = 'S9_dimer.png',
    label_fold  = 'fold2',       
    swap        = False,
    name_fold1  = 'Chemokine',
    name_fold2  = 'Dimer',
    threshold   = 0.5,
...
plot_collapsed_two(
    filepath    = './anc3_45E_af3_processed_tmscores_new.txt',
    out_png     = 'S9_chemokine.png',
    label_fold  = 'fold1',
    swap        = False,
    name_fold1  = 'Chemokine',
    name_fold2  = 'Dimer',
