...
plot_collapsed_two(
    filepath    = './anc3_native_scan_plddt.txt',
    out_png     = 'fig3E_open.png',
    label_fold  = 'fold1',       
    swap        = False,
    name_fold1  = 'Dimer',
    name_fold2  = 'Chemokine',
    threshold   = 0.5,
    fold1_color = 'gold',          # 'red' or 'gold'
)

plot_collapsed_two(
    filepath    = './anc3_45E_scan_plddt.txt',
    out_png     = 'fig3E_closed.png',
    label_fold  = 'fold2',
    swap        = False,
    name_fold1  = 'Dimer',
    name_fold2  = 'Chemokine',
