...
def plot_collapsed_one(filepath, out_png=None, name_folded='Folded', threshold=0.5,
    ...
    fig.legend(handles=[
        mpatches.Patch(color=C1, label=f'{name_folded} (≥{threshold}% of AAs)'),
...
plot_collapsed_one(
    filepath    = './6SOW_L39_scan_plddt.txt',
    out_png     = './fig5D_open.png',
    name_folded = 'Folded',
    threshold   = 0.5,
    fold1_color = 'red',
)
...
plot_collapsed_one(
    filepath    = './6SOW_L39E_scan_plddt.txt',
    out_png     = './fig5D_closed.png',
    name_folded = 'Folded',
    threshold   = 0.5,
    fold1_color = 'red',
)
